...
<nav class='navbar navbar-expand-lg navbar-light bg-light'>
    ...
    <center>
        <h3>Liste des experiences professionnelles</h3>
        <table class='table'>
  <thead>
    <tr>
  ...
  <tbody>
    <?php
      ...
      echo "<tr>
        ...
        <td><a href='../../php/supprimerExpPro.php?id=".$data[$key]['id']."'>Supprimer</a></td>
        </tr>
  ...
  <div class='modal-dialog'>
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <form action='../../php/modifierExpPro.php?id=".$data[$key]['id']."' method='post'>
        <div class='mb-3'>
